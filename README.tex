...
\texttt{financial\_info} [AR00200T] & 20135250$\times$63 & \texttt{bill\_usage\_clean.R} & \texttt{ADJUSTED\_BILL\_AMT}, \texttt{ITEM\_SUMMARY} & account, location \\
...
\texttt{BILL\_TP} & bill type (first, regular, final, resume, monthly) & character & \texttt{FIRST}, \texttt{REGLR}, \texttt{FINAL}, \texttt{RESUME}, \texttt{MSTMT} \\
