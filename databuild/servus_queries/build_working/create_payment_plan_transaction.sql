CREATE OR REPLACE TABLE `servus-291816.portland_working.payment_plan_transaction` AS
WITH ranked_payment_plan_transaction AS (
  ...
  FROM `servus-291816.portlandWater.payment_plan_transaction`
)
SELECT
...
INNER JOIN `servus-291816.portland_working.payment_plan` AS payment_plan
