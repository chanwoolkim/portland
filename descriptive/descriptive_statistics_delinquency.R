...
payment_var_name_list <- c("Delinquency Rate",
                           ...
                           "Financial Assistance Tier - 2020",
                           "Financial Assistance Tier - 2021",
                           "Financial Assistance Tier - 2022",
...
count_var_name_list <- c("Total Count",
                         ...
                         "Financial Assistance - 2021",
                         "Financial Assistance - 2022",
                         "Financial Assistance Tier 1 - 2020",
                         "Financial Assistance Tier 2 - 2020",
                         "Financial Assistance Tier 1 - 2021",
                         "Financial Assistance Tier 2 - 2021",
                         "Financial Assistance Tier 1 - 2022",
                         "Financial Assistance Tier 2 - 2022",
                         "Crisis Voucher",
                         "Crisis Voucher - 2020",
                         "Crisis Voucher - 2021",
                         "Crisis Voucher - 2022")
...
tab <- TR(c("", "Delinquency Rate", "Shutoff Rate"), cspan=c(1, 2, 2)) +
...
# How much of delinquent households experienced shutoff?
account_info_merge %>% filter(delinquent_2019>0) %>% group_by(cutoff_2019) %>% summarise(count=n())
